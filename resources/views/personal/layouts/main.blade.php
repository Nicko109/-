    ...
    <div class="container container--with-sidebar">
        <header class="main-header">
            <a href="{{ route('personal.main.index') }}">
                <img src="{{ asset('img/logo.png') }}" width="153" height="42" alt="Логотип Дела в порядке">
            </a>

            <div class="main-header__side">
                <a class="main-header__side-item button button--plus open-modal" href="{{ route('main.task.create') }}">Добавить задачу</a>
...
<footer class="main-footer">
    <div class="container">
        ...
        <a class="main-footer__button button button--plus" href="{{ route('main.task.create') }}">Добавить задачу</a>
