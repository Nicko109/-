...
Route::group(['middleware' => 'auth'], function () {
    Route::prefix('personal')->group(function () {
        Route::get('/', [App\Http\Controllers\Main\IndexController::class, 'index'])->name('personal.main.index');

        Route::prefix('projects')->group(function () {
            Route::get('/create', [App\Http\Controllers\Main\ProjectController::class, 'create'])->name('main.project.create');
            Route::post('/', [App\Http\Controllers\Main\ProjectController::class, 'store'])->name('main.project.store');
        });
